...
{
    public class LastOasisClassic : SteamCMDAgent
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.LastOasisClassic", // WindowsGSM.XXXX
        ...
        public override string AppId => "920720 -beta classic"; // Game server appId, LastOasis is 920720

        // - Standard Constructor and properties
        public LastOasisClassic(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
